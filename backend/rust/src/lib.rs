//! Rust release-gate engine for Automation Risk Checklist.
//!
...
pub const PRODUCT_SLUG: &str = "automation-risk-checklist";
pub const PRODUCT_TITLE: &str = "Automation Risk Checklist";
