  ...
  "criteria": [
    {
      ...
      "guidance": "Implement and verify data sensitivity rubric with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify failure mode checklist with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "rollback-plan",
      "label": "Rollback plan",
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify rollback plan with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      ...
      "weight": 15,
      "defaultStatus": "not-started",
      "guidance": "Implement and verify client acceptance test with evidence that a Volta student pod, mentor, and owner can understand."
    },
    {
      "id": "evidence-quality",
