export const v3 = {
  "productName": "Automation Risk Checklist",
  "productTier": "release",
  ...
  "capabilities": [
    "Domain-specific workbench: Automation Preflight Review",
    "Operational table: Failure mode register",
  ...
  "releaseChecklist": [
    ...
    "Risk Tier reaches production threshold",
    "Mitigation Coverage is documented with evidence",
    "Signoff Readiness has no unresolved blocker",
    "Risk report verified",
